...
1.  **Archivo de Datos:** Debes tener el archivo Excel con las facturas en la misma carpeta que el programa. El archivo debe llamarse exactamente: `FRASCL.xlsx`.
...
1.  **Abrir la carpeta del programa:** Navega hasta la carpeta en tu ordenador donde hayas guardado o descargado el programa.
...
3.  **Resultado:**
    - El programa creará automáticamente una carpeta llamada **`Facturas_Generadas`** dentro de esa misma carpeta.
    - Dentro de esa carpeta encontrarás un archivo PDF por cada cliente.

## ⚠️ Notas Importantes

- **Formato de los datos:** Si el Excel tiene errores de escritura, el PDF mostrará exactamente lo que ponga el Excel.
